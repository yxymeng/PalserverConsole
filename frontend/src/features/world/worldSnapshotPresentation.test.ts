...
const status = (overrides: Partial<WorldSnapshotSummary> = {}): WorldSnapshotSummary => ({
  contract: { queryVersion: 1, cacheSchema: "world-asset-cache", cacheSchemaVersion: 16, metadataSchema: "palserver-console-world-metadata", metadataSchemaVersion: 1, metadataDataVersion: "2026.08.25.3" },
