...
function status(snapshotId: string, parseStatus: WorldStatus["parseStatus"], reparseGeneration = 1): WorldStatus {
  return {
    contract: { queryVersion: 1, cacheSchema: "world-asset-cache", cacheSchemaVersion: 17, metadataSchema: "palserver-console-world-metadata", metadataSchemaVersion: 1, metadataDataVersion: "2026.08.25.3" },
